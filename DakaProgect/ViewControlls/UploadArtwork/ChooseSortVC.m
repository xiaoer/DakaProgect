...
- (void)viewDidLoad {
    ...
    NSMutableArray *normalArray = [[NSMutableArray alloc] initWithObjects:@"youhua_normal",@"bingxi_nomal",@"banhua_nomal",@"shuicai_normal",@"shuimo_normal",@"shugao_normal",@"sumiao_normal",@"zonghe_normal",@"diaoshu_normal",@"yangsheng_normal",@"",@"",@"mingjian_normal",@"yuqi_normal",@"ciqi_normal",nil];
    NSMutableArray *selectedArray = [[NSMutableArray alloc] initWithObjects:@"youhua_selected",@"bingxi_selected",@"banhua_selected",@"shuicai_selected",@"shuimo_selected",@"shugao_selected",@"sumiao_selected",@"zonghe_selected.png",@"diaoshu_selected",@"yangsheng_selected",@"",@"",@"mingjian_selected",@"yuqi_selected",@"ciqi_selected",nil];
    
//    NSMutableArray *nameArray = [[NSMutableArray alloc] initWithObjects:@"油画",@"丙烯",@"版画",@"水彩",@"水墨",@"书法手稿",@"素描手绘",@"综合材料",@"雕塑装置",@"艺术衍生品",@"",@"",@"民间美术",@"玉器",@"瓷器",nil];
